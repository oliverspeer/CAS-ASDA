...
sharing.p <- sharing.p |> 
  mutate(na.user = ifelse(is.na(user), "prog", "beob"))
...
ggplot(data = sharing.p.p, aes(x = ID)) +
  ...
  geom_line(aes(y = unterer_PI, 
                ...
                linetype = "PI"), color = "grey", alpha=0.5) +
  geom_line(aes(y = oberer_PI, 
                #color = na.user, group = 1, 
                linetype = "PI"), color = "grey", alpha=0.5) +
  scale_color_manual(values = c("beob" = "darkgrey", "prog" = "blue")) +
  scale_linetype_manual(
    values = c("user" = "solid", "PI" = "dashed"),
    name = "Linientyp",
